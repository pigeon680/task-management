                    ...
                    <form action="{{ route('home.index') }}" method="get">
                        <div class="row mt-2 mb-2">
                            ...
                            <div class="col-2 my-auto">
                                <button type="submit" class="my-auto btn bg-gradient-dark mt-2 w-100"><i
                                        class="fas fa-search" aria-hidden="true"></i>&nbsp;&nbsp;Filter Tasks</button>
                            </div>
                            <div class="col-2 my-auto">
                                <a href="{{ route('home.index') }}" class="my-auto btn bg-gradient-danger mt-2 w-100"><i
                                        class="fas fa-times" aria-hidden="true"></i>&nbsp;&nbsp;Reset Filter</a>
                            </div>
                        </div>
                    </form>
                    {{-- <ul class="list-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="edit-task-form-task-name"
                                                                    class="form-control-label">Task Name</label>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="py-3 text-center">
                                                    ...
                                                    <h4 class="text-gradient text-danger mt-4">Are you sure you want to
                                                        delete!</h4>
                ...
                <form action="{{ route('projects.insert') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="add-project-form-project-name" class="form-control-label">Project
                                        Name</label>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="add-project-form-project-color" class="form-control-label">Project
                                        Color</label>
